...
debug:
	...
	cl $(DEBUG_COMPILER_OPTIONS) /I $(INCLUDES_DIRECTORY) /Fe:$(DEBUG_EXE_DIRECTORY)\ /Fo:$(DEBUG_OBJ_DIRECTORY)\ src\*.cpp /link /LIBPATH:$(LIBRARIES_DIRECTORY) $(DEPENDENCIES)
...
release:
	...
	cl $(RELEASE_COMPILER_OPTIONS) /I $(INCLUDES_DIRECTORY) /Fe:$(RELEASE_EXE_DIRECTORY)\ /Fo:$(RELEASE_OBJ_DIRECTORY)\ src\*.cpp /link /RELEASE /LIBPATH:$(LIBRARIES_DIRECTORY) $(DEPENDENCIES)
